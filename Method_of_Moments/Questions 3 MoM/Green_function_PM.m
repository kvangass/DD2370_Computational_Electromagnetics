function Green = Green_function_PM( xp )
...
global k p kx eps reg E xm

z  = 0;
zp = 0;

Green = Green_Ewald_spatial( xm-xp,z,zp,k,kx,p,E,reg,eps ) + Green_Ewald_spectral( xm-xp,z,zp,k,kx,p,E,eps );
